...
/**
 * Create a session cookie after Adobe IMS sign-in (same model as AEM author).
 * Stores user identity and tokens so the app can recognize the user and call Adobe APIs if needed.
 */
